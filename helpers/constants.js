...
// Length in bits
exports.MAGIC_DOUBLE_BLIND_BASE_MESSAGE_LEN = 800;
...
exports.MAX_BODY_PADDED_BYTES = 800; // NOTE: this must be the same as the arg to sha the remainder number of bytes in the email in main args circom
